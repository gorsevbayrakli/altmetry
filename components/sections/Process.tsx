...
export default function Process() {
  return (
    <section id="how-we-work" className="px-6 py-24 sm:px-8 lg:px-12 lg:py-36">
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-14 md:grid-cols-5">
          {processSteps.map((step, i) => (
            <PopReveal key={step.letter} delay={i * 0.09}>
              <div className="flex items-baseline gap-3 border-t border-ink/15 pt-6">
                <span
                  className={cn(
                ...
                <span className="font-display text-xs tabular-nums text-ink/40">
                  {step.number}
                </span>
              </div>
